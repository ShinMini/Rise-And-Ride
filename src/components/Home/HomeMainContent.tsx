...
const HomeMainContent: FC = () => {
    ...
    const changeCard = (direction: number) => {
        if(direction === 1) {
            (activeCardIndex === cards.length - 1) ? setActiveCardIndex(0) : setActiveCardIndex(activeCardIndex + 1)
        }
        else {
    ...
    if(cards)
        return (
                <Container>
                    <HomeHeaderContent display={displayHeader}/>
                    ...
                    <ScrollView
                            ...
                            onScroll={({nativeEvent}) => {
                                if(currentScrollOffsetY > nativeEvent.contentOffset.y) { // scroll up
                    ...
                    >
                        ...
                        <ContentButton onPress={() => navigation.navigate('HomeDetail', {cardId: activeCardIndex})}
                        ...
                        <SmallText>
                            ...
                            * 이용경과일수 : 전월 대금 결제일 익일부터 당월 대금 결제일까지의 기간에 해당하는 일수
                            ...
                            ⑨ 제32조 제6항, 제34조 제1항은 2018년 12월 1일부터 적용합니다.
