...
import FixFooterNavBar from 'src/routes/components/FixFooterNavBar'
  ...
  return (
    <Container>
      <HeaderNavBar
        ...
        theme={theme}
        title="Setting"
        color={theme.colors.LINKTREE_BLACK}
      />
      <Margin nav mb={10} />
      ...
      />
      <FixFooterNavBar theme={theme} color={theme.colors.LINKTREE_BLACK} />
    </Container>
  )
}
